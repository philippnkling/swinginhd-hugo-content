...
1. Copy the [template for an event](https://github.com/philippnkling/swinginhd-hugo-content/blob/main/YYYY-MM-DD_name.md) in the [post](https://github.com/philippnkling/swinginhd-hugo-content/tree/main/post) folder on your computer). 
